...
You are a specialized agent building ONLY the font_system_api component.
...
### Purpose
Public API and orchestration layer for the complete font system
...
- ✅ Work within this directory: `components/font_system_api/`
...
```python
# components/font_system_api/tests/integration/test_component.py
...
def check_health():
    ...
    return {"status": "healthy", "component": "font_system_api"}
```
...
**Location**: Your work is in `components/font_system_api/`
...
```bash
python ../../orchestration/git_retry.py "font_system_api" "feat: Add new capability"
```

**Option 2: Direct git with manual retry**
```bash
# Stage only your component files
git add components/font_system_api/

# Commit with component prefix
git commit -m "[font_system_api] feat: Add new capability"
...
```
[font_system_api] <type>: <description>
...
```bash
git status components/font_system_api/
# or
python ../../orchestration/git_status.py "font_system_api"
```
...
- [ ] Read API contract: `../../contracts/font_system_api-api.yaml`
...
6. **Commit** with TDD pattern
   - Use retry wrapper:
   - `python ../../orchestration/git_retry.py "font_system_api" "test/feat/refactor: [description]"`
...
python ../../orchestration/git_retry.py "font_system_api" "feat: implement user registration
...
### API Contract
- Location: `../../contracts/font_system_api-api.yaml`
...
```bash
python orchestration/test_quality_checker.py components/font_system_api
```
...
2. **Commit immediately** without asking permission:
   ```bash
   git add .
   git commit -m "feat(font_system_api): add input validation for common formats
...
Component sections:
- Main API Interface (lines 238-295)
